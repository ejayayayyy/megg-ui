  ...
  return (
    <div className="flex flex-col gap-6 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          ...
          <div className="col-span-1 border border-gray-300 transition-colors duration-150 hover:bg-gray-100 rounded-lg p-4 flex">
            <div className="flex-1 flex flex-col gap-4">
              <h3 className="font-medium mb-">Total Inspections</h3>
          ...
          <div className="col-span-1 border border-gray-300 transition-colors duration-150 hover:bg-gray-100 rounded-lg p-4 flex">
            <div className="flex-1 flex flex-col gap-4">
              <h3 className="font-medium mb-">Most Common Defect</h3>
              <p
                className={`text-4xl font-bold ${getSizeTypeColor(
                  mostCommonSize
                )}`}
              >
                {mostCommonSize}
          ...
          <div className="col-span-1 md:col-span-2 xl:col-span-1 border border-gray-300 transition-colors duration-150 hover:bg-gray-100 rounded-lg p-4 flex">
            <div className="flex-1 flex flex-col gap-4">
              ...
              <p className="text-4xl font-bold text-yellow-400">0 /hr</p>

              <div className="flex flex-col gap-1">
                <div className="flex items-center text-sm mt-">
                  <p className="text-gray-500">Avg. Items per Hour</p>
                </div>
      ...
      <div className="flex flex-col gap-6 bg-white border border-gray-300 rounded-2xl shadow w-auto p-6">
        <div className="flex justify-between items-center">
          <div className="flex flex-col gap-1">
            <h3 className="font-medium text-xl">Defect Distribution</h3>
        ...
        <div className="flex items-center justify-center gap-4 ">
          <div className=" flex items-center gap-2 px-4 py-2 border border-gray-300 transition-colors duration-150 hover:bg-green-100 rounded-full">
          ...
          <div className=" flex items-center gap-2 px-4 py-2 border border-gray-300 transition-colors duration-150 hover:bg-orange-100 rounded-full">
          ...
          <div className=" flex items-center gap-2 px-4 py-2 border border-gray-300 transition-colors duration-150 hover:bg-red-100 rounded-full">
